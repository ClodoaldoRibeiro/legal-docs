...
<section class="legal-section">
  <p>
    Este aplicativo foi desenvolvido para ajudar você a gerenciar aniversários de forma simples.
    Levamos a sua privacidade a sério e explicamos abaixo como tratamos os dados.
  </p>
</section>
...
<section class="legal-section">
  ...
  <ul>
    ...
    <li>Gerar notificações locais (no dia e 5 dias antes do aniversário)</li>
  </ul>
</section>
